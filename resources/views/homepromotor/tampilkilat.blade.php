    ...
    <header class="header-part">
        <div class="container">
            <div class="header-content">
                ...
                <a href="login.html" class="header-widget" title="My Account"><img src="{{ asset('template/mironmahmud.com/greeny/assets/ltr/images/user.png')}}"
                        alt="user" /></a>
                ...
                <div class="col-lg-6">
                    <div class="details-gallery">
                        ...
                        <ul class="details-preview">
                            <li><img src="images/product/makanan 1.jpg" alt="product"></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                    <ul class="product-navigation">
                        <li class="product-nav-prev"><a href="#"><i class="icofont-arrow-left"></i>produk
                                sebelumnya <span class="product-nav-popup"><img src="images/makanan/hokben1.jpg"
                        ...
                        <li class="product-nav-next"><a href="#">Produk selanjutnya <i
                                    class="icofont-arrow-right"></i><span class="product-nav-popup"><img
                                        src="images/makanan/hokben2.png" alt="product"><small>green
                                        chilis</small></span></a></li>
                    </ul>
                    <div class="details-content">
                        <h3 class="details-name">Promo Hokben Spesial Hoka Ramen Mulai Dari Rp
                            55K
                        </h3>
                        <div class="details-meta">
                            <p style="color: red; font-weight: bold; font-size: medium;">Berlaku Hingga : 28
                                February 2023</p>
                        </div>
                        <hr>
                ...
                <div class="col-lg-12">
                    <div class="product-details-frame mt-3">
                        ...
                        <div class="tab-descrip">
                            <p>Rekomendasi makan siang istimewa bareng keluarga atau temen kantor nih. </p>
                            <br>

                            <p>Kamu bisa pesan paket Special Hoka Ramen di HokBen. Bebas pilih Hokkaido Miso atau Tori
                                Paitan sudah termasuk Fried Dumpling plus Ocha*, only 55k nett* . Yang terbaru ada
                                pilihan Spicy Ramen juga lho, yang #pedasnyanampol!!!</p>
                            <br>
                            <p>Cuss langsung dine in ke store HokBen terdekat. Sama-sama kita #ngerameninhokben</p>
