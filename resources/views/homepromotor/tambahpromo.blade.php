                                ...
                                <form action="/insertpromo" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6 col-lg-12">
                                        <div class="form-group">
                                            <label class="form-label">Kategori Promo</label>
                                            <select name="kategoripromo" class="tom-select">
                                                <option></option>
                                                @foreach ($data as $kategori)
                                                <option value="{{ $kategori->id }}" {{ old('kategoripromo') == $kategori->id ? 'selected' : '' }}>
                                                    {{ $kategori->kategori }}
                                                </option>
                                                @endforeach
                                            </select>
...
<script>
    // Inisialisasi plugin tomselect
    var select = new TomSelect(".tom-select", {
        create: false, // Untuk menonaktifkan fitur menambahkan opsi baru pada select
    });
</script>
