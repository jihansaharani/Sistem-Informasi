...
<head>
    ...
    <title>Tambah Kilat - GudangPromo</title>
    ...
    <header class="header-part">
        <div class="container">
            <div class="header-content">
                ...
                <a href="profile.html" class="header-widget" title="My Account"><img src="{{ asset('template/mironmahmud.com/greeny/assets/ltr/images/user.png')}}"
                        alt="user" /></a>
                ...
                <div class="col-lg-12">
                    <div class="account-card">
                        <div class="account-title">
                            <h3 style="margin-left: 40%;">Tambah kilat</h3>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-12">
                                    <div class="form-group"><input
                                            class="form-control" value="{{ Auth()->user()->id}}" type="hidden" name="emailpromotor" placeholder=""></div>
                                </div>
                                <div class="col-md-6 col-lg-12">
                                    <div class="form-group"><label class="form-label">Nama Promo</label><input
                                            class="form-control" type="text" name="namapromo" placeholder=""></div>
                                </div>
                                {{-- direlasikan --}}
                                <div class="col-md-6 col-lg-12">
                                ...
                                <textarea class="form-control" name="deskripsipromo" id="Mysummernote" cols="30" rows="10"></textarea></div>
                                </div>

                                <div class="col-md-6 col-lg-12">
                                    <div class="form-group"><label class="form-label">Masa Promo</label><input
                                            class="form-control" type="date" name="masapromo" placeholder=""></div>
                                </div>
                                <div class="col-md-6 col-lg-12">
                                    <div class="form-group"><label class="form-label">Limit Promo</label><input
                                            class="form-control" type="number" name="limit" placeholder=""></div>
                                </div>
                                <div class="mb-3">
                                    <div class="upload__box">
                                        <div class="upload__btn-box">
                                            <label class="upload__btn">
                                                <p class="mb-0"><label class="form-label">Masukkan Sampul Produk Anda</label></p>
                                                <input name="sampulkilat" type="file"
                                ...
                                <div class="mb-3">
                                    <div class="upload__box">
                                        <div class="upload__btn-box">
                                            <label class="upload__btn">
                                                <p class="mb-0"><label class="form-label">Masukkan Foto Produk Kilat Anda</label></p>
                                                <input name="fotokilat[]" type="file" multiple=""
                                ...
                                <div class="col-lg-4">
                                    <button class="btn btn-warning">Tambah kilat</button>
