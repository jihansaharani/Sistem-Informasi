                        ...
                        <div class="col">
                            <div class="product-card ">
                                ...
                                <div class="product-media product-disable">
                                    <a class="product-image"style="margin-left: 13px;" href="/deskripsifoto/{{ $promo->id }}"><img
                    ...
                    @elseif ($promo->limit == 0)
                        <div class="col">
                            <div class="product-card product-disable">
                                <div class="product-media">
                                    <div class="product-label"></div>
                                    <a class="product-image" href="/deskripsifoto/1" style="margin-left: 13px;"><img
                                            style="height: 200px; width:200px; margin-right: 15px; margin-top: 50px;"
                                            src="sampul/{{ $promo->sampul }}" alt="product" /></a>
