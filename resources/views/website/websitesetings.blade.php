                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $item)
                                        <tr class="border-bottom-secondary">
                                            ...
                                            <td><img src="logo/{{ $item->logowebsite }}" alt=""></td>
                                            <td>{{ $item->deskripsiwebsite }}</td>
                                            <td>{{ $item->email }}</td>
                                            <td>{{ $item->alamat }}</td>
                                            {{-- <td>{{ $item->ig }}</td> --}}
                                            <td>
                                                <a href="{{ Route('editwebsite', ['id' => $item->id]) }}" method="get">
                                                    <button class="btn btn-success mb-1" type="button"><i
                                                            class="fa-solid fa-pen"></i></button>
                                                </a>
                                                <a href="/detailwebsite/{{ $item->id }}" method="get">
                                                    <button class="btn btn-info"
                                                        type="button"><i class="fa-solid fa-eye"></i></button>
                                                </a>
                                                {{-- <a href="#"><button class="btn btn-danger deletekategori"
