            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="project-info-box">
                        <p><b>Email Website : </b>{{ $data->email }}</p>
                        <p><b>No Telepon : </b>{{ $data->notelepon }}</p>
                        <p><b>Alamat : </b>{{$data->alamat}}</p>
                        <p><b>Instagram : </b>{{ $data->ig }}</p>
                        <p><b>Facebook : </b>{{ $data->facebook }}</p>
                        <p><b>Twitter : </b> {{ $data->twitter }}</p>
                    </div>
                    <div class="project-info-box" style="width: 1100px;">
                        <h5>Deskripsi Website : </h5>
                        <p class="mb-0">{!!$data->deskripsiwebsite!!}</p>
                    </div>

                    <!-- / project-info-box -->
                </div><!-- / column -->
                <div class="col-md-7">
                    <img src="{{ asset('logo/' . $data->logowebsite) }}" alt="project-image" class="rounded" style="width: 500px;height:400px;">
                    <!-- / project-info-box -->
                  </div>
