                ...
                <div class="col-md-5">
                    <div class="project-info-box mt-0">
                        ...
                        <p class="mb-0">Rekomendasi makan siang istimewa bareng keluarga atau temen kantor nih.
                            Kamu bisa pesan paket Special Hoka Ramen di HokBen. Bebas pilih Hokkaido Miso atau Tori Paitan
                            sudah
                            termasuk Fried Dumpling plus Ocha*, only 55k nett* . Yang terbaru ada pilihan Spicy Ramen juga
                            lho,
                            yang #pedasnyanampol!!!
                    ...
                    <div class="project-info-box">
                        ...
                        <a href="/list-promo">
                            <button class="btn btn-success mb-1" style="border-radius: 5px;" type="button">Terima
                                Promo</button>
                        </a>
