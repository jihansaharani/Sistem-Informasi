...
<head>
    ...
    <title>Gudang Promo - Syarat Dan Kententuan</title>
...
<body>
        ...
        <div class="container">
            <div class="header-content">
                <div class="header-media-group"><button class="header-user"><img src="images/user.png"
                            alt="user"></button><a href="/"><img src="template/mironmahmud.com/greeny/assets/ltr/images/logo.png" alt="logo"></a><button
                        class="header-src"><i class="fas fa-search"></i></button></div><a href="/"
                    class="header-logo"><img src="{{ asset('template/mironmahmud.com/greeny/assets/ltr/images/removepromo.png') }}" alt="logo"></a>

                            <a href="/login" class="header-widget ms-auto" title="My Account"><img
    ...
    <section class="inner-section single-banner" style="background: url({{ asset('templatebanner/bannerwebpromosi.jpg') }}) no-repeat center;">
        <div class="container">
            <h2>Syarat Dan Ketentuan Kami</h2>
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="faq-parent">
                        @foreach ($data as $sk)
                        <div class="faq-child">
                            <div class="faq-que"><button>{{$sk->syarat}}</button></div>
                        </div>
                        @endforeach
                        {{-- <div class="col-lg-4">
                            <a style="color:black;" href="/register">
                                <div class="btn btn-success">kembali</div>
                            </a>
                        </div> --}}
                    </div>
                </div>
