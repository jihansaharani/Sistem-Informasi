                ...
                <div class="col-12 col-sm-10 col-md-12 col-lg-12 col-xl-10">
                    ...
                    <div class="user-form-card">
                        ...
                        <div class="user-form-group">
                            ...
                            <form class="user-form" action="/registerPengunjung" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <div class="form-group"><label class="form-label">Nama Lengkap</label>
                                        <input type="text" class="form-control" value="{{ old('name') }}"
                                            name="name" placeholder="Masukkan Nama Kamu" />
                                    </div>
                                </div>
                                @error('name')
                                ...
                                <div class="form-group">
                                    <div class="form-group"><label class="form-label">Email</label>
                                        <input type="email" class="form-control" value="{{ old('email') }}"
                                            name="email" placeholder="Masukkan Email Kamu" />
                                    </div>
                                </div>
                                @error('email')
                                    <div class="alert alert-danger mb-3"> {{ $message }} </div>
                                ...
                                <div class="form-group"><label class="form-label">Kata Sandi</label><input
                                        ...
                                        class="form-control" placeholder="Masukkan Kata Sandi Kamu" />
                                </div>
                                @error('password')
                                    <div class="alert alert-danger mb-3"> {{ $message }} </div>
                                @enderror
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" name="terms" value="1"
                                        id="check" {{ old('terms') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="check">Dengan mendaftar, saya menyetujui <a
                                            href="/SyaratDanKetentuan">Semua Syarat & Ketentuan</a></label>
                                </div>
                                @error('terms')
                                    <div class="alert alert-danger mb-3"> {{ $message }} </div>
                                @enderror
