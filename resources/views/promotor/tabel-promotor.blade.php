            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                            ...
                            {{-- <form action="{{ Route('tabelpromotor') }}" method="get" class="card-header">
                            ...
                            <table class="table" id="DataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-bottom-secondary">
                                        ...
                                        <td>{{ $item->email }}</td>
                                            <td>
                                                <a href="#"><button class="btn btn-danger deletepromotor" data-id="{{ $item->id }}"
                                                    data-nama="{{ $item->namapromotor }}" type="button"><i
...
@push('script')
    ...
    <script>
        $('.deletepromotor').click(function() {
            var siswaid = $(this).attr('data-id');
            var nama = $(this).attr('data-nama');

            Swal.fire({
                title: 'Yakin?',
                text: "Kamu akan menghapus data promotor dengan nama " + nama + "",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    window.location = "/hapuspromotor/" + siswaid + ""
                    // Swal.fire(
                    //     'Deleted!',
