...
<head>
    ...
    <title>Deskripsi {{$data->namapromo}}</title>
...
<body>
    ...
    <aside class="cart-sidebar">
        ...
        <ul class="cart-list">
            <li class="cart-item">
                <div class="cart-media"><a href="#"><img src="template/mironmahmud.com/greeny/assets/ltr/images/product/01.jpg" alt="product"></a><button
            ...
            <li class="cart-item">
                <div class="cart-media"><a href="#"><img src="template/mironmahmud.com/greeny/assets/ltr/images/product/02.jpg" alt="product"></a><button
                        class="cart-delete"><i class="far fa-trash-alt"></i></button></div>
                <div class="cart-info-group">
                    <div class="cart-info">
                        <h6><a href="product-single.html">existing product name</a></h6>
            ...
            <li class="cart-item">
                <div class="cart-media"><a href="#"><img src="template/mironmahmud.com/greeny/assets/ltr/images/product/03.jpg" alt="product"></a><button
                        class="cart-delete"><i class="far fa-trash-alt"></i></button></div>
                <div class="cart-info-group">
                    <div class="cart-info">
                        <h6><a href="product-single.html">existing product name</a></h6>
            ...
            <li class="cart-item">
                <div class="cart-media"><a href="#"><img src="template/mironmahmud.com/greeny/assets/ltr/images/product/04.jpg" alt="product"></a><button
                        class="cart-delete"><i class="far fa-trash-alt"></i></button></div>
                <div class="cart-info-group">
                    <div class="cart-info">
                        <h6><a href="product-single.html">existing product name</a></h6>
            ...
            <li class="cart-item">
                <div class="cart-media"><a href="#"><img src="template/mironmahmud.com/greeny/assets/ltr/images/product/05.jpg" alt="product"></a><button
                        class="cart-delete"><i class="far fa-trash-alt"></i></button></div>
                <div class="cart-info-group">
                    <div class="cart-info">
                        <h6><a href="product-single.html">existing product name</a></h6>
    ...
    <aside class="nav-sidebar">
        <div class="nav-header"><a href="#"><img src="template/mironmahmud.com/greeny/assets/ltr/images/logo.png" alt="logo"></a><button class="nav-close"><i
                        ...
                        <ul class="details-preview">
                            <li>
                                <div class="image-container">
                                    <img class="image" src="../fotopromo/{{$data->fotopromo}}" alt="product"></div></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                    <ul class="product-navigation">
                        <li class="product-nav-prev"><a href="#"><i class="icofont-arrow-left"></i>produk
                                sebelumnya <span class="product-nav-popup"><img class="image" src="{{asset('fotopromo/' .$data->fotopromo)}}"
                                        alt="product"><small>{{$data->fotoproduk}}</small></span></a></li>
                        <li class="product-nav-next"><a href="#">Produk selanjutnya <i
                                    class="icofont-arrow-right"></i><span class="product-nav-popup"><img class="image" src="{{asset('fotopromo/' .  $data->fotopromo)}}"
                                        alt="product"><small>{{$data->fotoproduk}}</small></span></a></li>
                    </ul>
                    <div class="details-content">
                        <h3 class="details-name">{{$data->namapromo}}</h3>
                        <div class="details-meta">

                            <p style="color: red; font-weight: bold; font-size: medium;">Berlaku Hingga : {{$data->masapromo}}</p>
                        ...
                        <div class="details-list-group"><label class="details-list-title">tag:</label>
                            <ul class="details-tag-list">
                                <li><a href="#">{{$data->kategoripromo}}</a></li>
                            </ul>
                        </div>
    ...
    <section class="inner-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="product-details-frame mt-3">
                        <h3 class="frame-title">Tentang Deals</h3>
                        <div class="tab-descrip">
                            <p>{{$data->deskripsipromo}} </p>
                        </div>
                    </div>
