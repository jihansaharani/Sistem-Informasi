                ...
                <div class="col-lg-3">
                    ...
                    <div class="shop-widget">
                        ...
                        <form action="/filter" method="GET">
                                ...
                                <li>
                                    <div class="shop-widget-content">
                                        <input type="checkbox" id="terbaru" name="pilihan" value="terbaru"
                                            @if (in_array('terbaru', (array) request('pilihan'))) checked @endif>
                                ...
                                <li>
                                    <div class="shop-widget-content">
                                        <input type="checkbox" id="terpopuler" name="pilihan" value="terpopuler"
                                            @if (in_array('terpopuler', (array) request('pilihan'))) checked @endif>
                                ...
                                <li>
                                    <div class="shop-widget-content">
                                        <input type="checkbox" id="unggulan" name="pilihan" value="unggulan"
                                            @if (in_array('unggulan', (array) request('pilihan'))) checked @endif>
                                        <label for="unggulan">Promo Unggulan</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="shop-widget-content">
                                        <input type="checkbox" id="kilat" name="pilihan" value="kilat"
                                            @if (in_array('kilat', (array) request('pilihan'))) checked @endif>
                                        <label for="kilat">Promo Kilat</label>
                                    </div>
                                </li>
                                        ...
                                        <li>
                                            <div class="shop-widget-content">
                                                <input type="checkbox" name="kategori[]" id="{{ $item->kategori }}"
                                                    value="{{ $item->id }}"
                                                    @if (in_array($item->id, request('kategori', []))) checked @endif>
                            ...
                            <a href="/filter" type="button" class="shop-widget-btn"><i
                                    class="far fa-trash-alt"></i> <span>Hapus Filter</span></a>
                        </form>
                    </div>
                    {{-- EndFilter --}}
                                    ...
                                    <div class="product-card">
                                        <div class="product-media">
                                            <form id="promo-form-{{ $row->id }}" method="POST"
                                                ...
                                                action="{{ in_array( $row->id , $bookmark) ?  'unbookmark/'.$row->id : 'bookmark/'.$row->id }}">
                                                @csrf
                                                <button type="submit" class="product-wish wish"
                                                    data-status="{{ in_array( $row->id , $bookmark) ? '1' : '0' }}">
                                            ...
                                            <a class="product-image" href="/detpromo/{{ $row->id }}">
                                                <img src="{{ asset('sampul/' . $row->sampul) }}" alt="product"
                                                    style="height: 200px; width:200px;margin-left:5px;">
                                            </a><div class="product-widget"><a title="Lihat Produk" href="/detpromo/{{ $row->id }}" class="fas fa-eye"></a></div>
                                        </div>
                                        <div class="product-content">
                                            <h6 class="product-name"><a href="">{{ $row->namapromo }}</a></h6>
                                            <p style="color: red;">Berakhir : <br>
...
{{-- <script>
    // Ambil elemen checkbox dengan nama "pilihan"
    const checkboxes = document.querySelectorAll('input[name="pilihan"]');

    // Tambahkan event listener untuk setiap checkbox
    checkboxes.forEach((checkbox) => {
        checkbox.addEventListener('change', function() {
            // Jika checkbox dipilih, tambahkan atribut "checked"
            if (this.checked) {
                this.setAttribute('checked', 'checked');
            }
            // Jika checkbox tidak dipilih, hapus atribut "checked"
            else {
