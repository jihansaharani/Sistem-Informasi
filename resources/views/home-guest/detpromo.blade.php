                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <div class="view-details">
                                ...
                                <style>
                                    ...
                                    #deskripsiPromo {
                                        word-wrap: break-word; /* Memastikan kata yang terlalu panjang akan dipindahkan ke baris berikutnya */
                                        overflow-wrap: break-word; /* Memastikan kata yang terlalu panjang akan dipindahkan ke baris berikutnya */
                                        max-width: 50%; /* Membatasi lebar div menjadi 100% dari parent-nya */
                                    }
                                </style>
                ...
                <div class="col-lg-6">
                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                        <div class="home-category-slider slider-arrow slider-dots">
                            ...
                            <a class="slider-card">
                                <img style="height:475px;; width:100%;" src="{{ asset('fotopromo/' . $data->fotoproduk) }}" alt="fotoproduk" />
                            </a>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="details-meta">
                        <p style="color: red; font-weight: bold; font-size: medium;">Berlaku Hingga :
                            {{ \Carbon\Carbon::parse($promo->masapromo)->locale('id')->isoFormat('DD MMMM YYYY') }}</p>
                    </div>
                    <hr>
                    ...
                    <div class="details-list-group">
                        ...
                        <ul class="details-tag-list">
                                ...
                                <li>{{ $promo->kategoris->kategori }}</li>
                        </ul>
                    </div>
                    <style>
                    .details-list-group {
                   ...
                   <div class="details-list-group">
                    ...
                    <div id="deskripsiPromo">{!! $promo->deskripsipromo !!}</div> {{-- Tampilkan deskripsi promo --}}
                    {{-- @if (mb_strlen($promo->deskripsipromo) > 100) Jika deskripsi promo lebih dari 250 karakter --}}
                        {{-- <span id="showMore" style="cursor:pointer;color:rgb(228, 92, 38);">...Lihat Selengkapnya</span> Tampilkan link "Lihat Selengkapnya" --}}
                    {{-- @endif --}}
                </div>
                {{-- <script>
                    document.getElementById('showMore').addEventListener('click', function () {
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="details-content">
                            ...
                            <div class="details-list-group">
                                ...
                                <ul class="details-tag-list">
                                    <li>
                                        <p class="promo-deskripsi">{!! $promo->deskripsipromo !!}</p>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="product-details-frame">
                        ...
                        <form action="/komentar/{{$row->id}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group"><textarea class="form-control" name="konten"
                                            placeholder="Masukkan Ulasan"></textarea></div>
                                </div>
                                @if (Route::has('login'))
                                ...
                                <div class="col-lg-7">
                                    <button type="submit"class="btn btn-warning"><i class="icofont-paper-plane"></i> Kirim</button>
                                ...
                                <a href="/login">
                                    ...
                                    <div class="col-lg-7">
                                        <button type="button"class="btn btn-warning"><i class="icofont-paper-plane"></i> Kirim</button>
                                    </div>
                                    <style>
                                        .icofont-paper-plane {
                                           height: 20px;
                        ...
                        <div style="height: 500px; overflow-y: scroll;">
                            ...
                            <ul class="review-list">
                                ...
                                <li class="review-item">
                                    <div class="review-media" ><a class="review-avatar" href="#">
                                        ...
                                        <img class="user-avatar rounded-circle " src="{{ asset('user.png') }}"alt="User Avatar" />
                                        @else
                                        <img class="user-avatar rounded-circle" src="{{asset('fotoprofil/' . $row->user->fotoprofil)}}"
                                        alt="User Avatar">
                                        @endif
                                    <h5 class="review-meta"><a href="#">{{$row->name}}</a>
                                    <span class="timestamp">{{$row->created_at}}</span></h5>
                                    </div>
                                    ...
                                    <form action="/komentar/{{$row->id}}" method="post"
                                        ...
                                        <div class="col-lg-10">
                                            <div class="form-group" style="display: flex"><input class="form-control" name="konten"
                                                    placeholder="Balas...">
                                                    @if (Route::has('login'))
                                                    ...
                                                    <div class="button-container">
                                                        <div class="send-button">
                                                          <button type="submit"class="btn btn-warning" style="display: flex"><i class="icofont-reply"></i> Balas</button>
                                                        </div>
                                                        <div class="delete-button">
                                                            <button type="submit"class="btn btn-danger" style="display: flex"><i class="icofont-trash"></i> Hapus</button>
                                                        </div>
                                                      </div>
                                                    ...
                                                    <a href="/login">
                                                        ...
                                                        <div class="button-container">
                                                            <div class="send-button">
                                                              <button type="button"class="btn btn-warning" style="display: flex"><i class="icofont-reply"></i> Balas</button>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="review-media"><a class="review-avatar" href="#">
                                        ...
                                        @endif
                                            <h5 class="review-meta"><a href="#">{{$child->name}}</a><span
                                                    class="timestamp">{{$child->created_at}}</span></h5>
                                    </div>
                                    <p class="review-desc">{{$child->konten}}</p>
                            ...
                            <div class="review-media"><a class="review-avatar" href="#"> <img
                                    ...
                                    <h5 class="review-meta"><a href="#">{{$child2->name}}</a><span
                                            class="timestamp">{{$child2->created_at}}</span></h5>
                            </div>
                            ...
                            <div class="product-media">
                                <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                    class="product-image" href="{{ $d->id }}"><img
                                        ...
                                        <div class="product-widget"><a title="Lihat Produk" href="/detpromo/{{ $promo->id }}" class="fas fa-eye"></a></div>

                            </div>
                            <div class="product-content">

                                <h6 class="product-name"><a href="#product-view" data-bs-toggle="modal" style="max-width:175px;text-overflow: ellipsis; overflow:hidden"
                                    data-bs-target="#product-view">{{ $d->namapromo }}{{ Str::limit($d->namapromo, 2) }}</a>
                            </h6>
                                <p style="color: red;">Berakhir {{ \Carbon\Carbon::parse($d->masapromo)->locale('id')->isoFormat('DD MMMM YYYY') }}</p>
