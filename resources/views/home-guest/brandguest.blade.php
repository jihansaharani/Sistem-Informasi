                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            <div class="product-label"><label class="label-text new">Brand</label></div>
                            <a class="product-image" href="/detpromo/{{ $p->id }}"><img
                        ...
                        <div class="product-content">
                            ...
                            <h6 class="product-name"><a href="#product-view" data-bs-toggle="modal"
                                    data-bs-target="#product-view">{{ $p->namapromo }}</a></h6>
                                    <p style="color: red; font-weight:500;">Berakhir : {{ \Carbon\Carbon::parse($p->masapromo)->locale('id')->isoFormat('DD MMMM YYYY') }}</p>
