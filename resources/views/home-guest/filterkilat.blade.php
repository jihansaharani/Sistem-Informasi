                    ...
                    <div class="navbar-content">
                        <ul class="navbar-list">
                            <li class="navbar-item dropdown">
                                <a class="navbar-link" href="{{url('/')}}">Beranda</a>
                            </li>
                            <!-- Product Link -->
                            <li class="navbar-item dropdown">
            ...
            <div class="row content-reverse">
                <div class="col-lg-3">
                    ...
                    <div class="shop-widget">
                        ...
                        <form action="/filterkilat" method="POST"><input class="shop-widget-search" type="text" placeholder="Search...">
                            @csrf
                            <ul class="shop-widget-list ">
                                ...
                                <li>
                                    <div class="shop-widget-content"><input type="checkbox" id="kilat" name="pilihan" value="kilat"  {{$status == '3' ? 'checked' : ''}}><label
                                            for="brand3">Promo Kilat</label></div><span
                    ...
                    <div class="shop-widget">
                        ...
                        $no6=0;
                        @endphp
                        <h6 class="shop-widget-title">Filter Kategori</h6>
                            ...
                            <ul class="shop-widget-list shop-widget-scroll">
                                ...
                                <li>
                                    <div class="shop-widget-content"><input type="checkbox" id="cate10"><label
                                        ...
                                        class="shop-widget-number">@foreach ($data as $a)@php ++$no5 @endphp @endforeach{{$no5}}</span>
                                </li>
                                @endforeach
                                ...
                                <div class="product-media">
                                    <button class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                        class="product-image" href="/detpopuler/{{ $row->id}}"><img
                                            src="{{asset('fotopromo/'. $row->fotopromo)}}" alt="product"></a>
                                </div>
