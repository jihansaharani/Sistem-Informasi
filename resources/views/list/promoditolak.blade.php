...
@section('searchtolak')
    <li>
        <div class="right-header ps-0">
          <form action="{{ url('ditolak') }}" method="get" class="header-form input-group">
            <div class="input-group-prepend">
              <span class="input-group-text mobile-search">
               <button type="submit"><i class="fa fa-search"></i></button>
              </span>
            </div>
            <input class="form-control" type="search" name="cari"  value="{{ Request::get('cari') }}" placeholder="Cari Promo Di Tolak...">
          </form>
        </div>
      </li>
      <li class="serchinput">
        ...
        <div class="form-group search-form">
            <form action="{{ url('ditolak') }}" method="get">
                <input type="search" name="cari" value="{{ Request::get('cari') }}" placeholder="Cari Promo Di Tolak...">
            </form>
        </div>
    </li>
    @endsection
